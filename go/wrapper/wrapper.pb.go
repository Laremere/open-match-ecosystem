...
const (
	...
	FindMatchResponse_ASSIGNED  FindMatchResponse_State = 3
)
...
var fileDescriptor_270782662a219794 = []byte{
	...
	,
}
...
// ProfilesProviderClient is the client API for ProfilesProvider service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type ProfilesProviderClient interface {
	GetProfiles(ctx context.Context, in *GetProfilesRequest, opts ...grpc.CallOption) (*GetProfilesResponse, error)
}

type profilesProviderClient struct {
	cc *grpc.ClientConn
}

func NewProfilesProviderClient(cc *grpc.ClientConn) ProfilesProviderClient {
	return &profilesProviderClient{cc}
}

func (c *profilesProviderClient) GetProfiles(ctx context.Context, in *GetProfilesRequest, opts ...grpc.CallOption) (*GetProfilesResponse, error) {
	out := new(GetProfilesResponse)
	err := c.cc.Invoke(ctx, "/openmatchecosystem.wrapper.ProfilesProvider/GetProfiles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ProfilesProviderServer is the server API for ProfilesProvider service.
type ProfilesProviderServer interface {
	GetProfiles(context.Context, *GetProfilesRequest) (*GetProfilesResponse, error)
}

// UnimplementedProfilesProviderServer can be embedded to have forward compatible implementations.
type UnimplementedProfilesProviderServer struct {
}

func (*UnimplementedProfilesProviderServer) GetProfiles(ctx context.Context, req *GetProfilesRequest) (*GetProfilesResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method GetProfiles not implemented")
}

func RegisterProfilesProviderServer(s *grpc.Server, srv ProfilesProviderServer) {
	s.RegisterService(&_ProfilesProvider_serviceDesc, srv)
}

func _ProfilesProvider_GetProfiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetProfilesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProfilesProviderServer).GetProfiles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/openmatchecosystem.wrapper.ProfilesProvider/GetProfiles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfilesProviderServer).GetProfiles(ctx, req.(*GetProfilesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _ProfilesProvider_serviceDesc = grpc.ServiceDesc{
	ServiceName: "openmatchecosystem.wrapper.ProfilesProvider",
	HandlerType: (*ProfilesProviderServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetProfiles",
			Handler:    _ProfilesProvider_GetProfiles_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "go/wrapper/wrapper.proto",
